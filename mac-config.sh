...
sudo scutil --set ComputerName "MacBook jmlweb"
sudo scutil --set HostName "MacBook jmlweb"
sudo scutil --set LocalHostName "MacBook jmlweb"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "MacBook jmlweb"
